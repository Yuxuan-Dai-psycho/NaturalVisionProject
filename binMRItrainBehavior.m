...
jitter = unifrnd(0.1,0.3,nStim,1);

% Split stimuli into 4 runs
categoryName = reshape(categoryName, [],4);
categoryID = reshape(categoryID, [],4);
exampleName = reshape(exampleName, [],4);
cond = reshape(cond, [],4);
jitter = reshape(jitter, [],4);
